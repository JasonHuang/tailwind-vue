        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-[1.2em] lg:px-8" aria-label="Global">
            ...
            -->
                <transition name="fade">
                    <div v-if="isMenuVisible" ref="menu"
                        class="menu absolute top-12 z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                        <div class="p-4">
                            <div
